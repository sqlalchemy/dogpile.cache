...
# PBR provide mechanism to retrieve project informations and  automatically
# configure version number.
extensions = ['pbr.sphinxext', 'sphinx.ext.autodoc', 'sphinx.ext.intersphinx',
...
copyright = u'2011-2018 Mike Bayer'
